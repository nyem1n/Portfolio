...
export const cardData = {
  ...
  education: {
    ...
    items: [
      ...
      {
        text: "프로그래머스 데브코스 웹 풀스택 6기",
        description: "2025.01 ~ 2025.07",
      },
    ],
  },
  ...
  contact: {
    ...
    items: [
      ...
      {
        text: "✍️ Velog",
        link: "https://velog.io/@nemin/posts",
      },

      {
        text: "GitHub",
        link: "https://github.com/nyem1n",
      },
    ],
  },
};