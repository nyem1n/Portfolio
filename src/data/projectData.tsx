export const projectData = [
  ...
  },
  {
    ...
    purpose:
      ...
      role: `프론트엔드 개발 및 일부 백엔드 구현
      - 디자인 
      - UI 구현 및 API 연결 (AI 채팅, 앨범 표시)
      - 백엔드 구현 (API 연동, 필요한 API 구현)`,
    teamSize: "4명 (프론트엔드 4)",
    screenshots: [
  ...
  },
  {
    ...
    learnings: `기획과 디자인 단계에서 개발 방식을 미리 확실히 정해두는 것이 중요하다는 것을 배웠습니다.\n프론트엔드 개발자끼리 협업할 때와 달리, 백엔드와 협업할 때는 신경 써야 할 부분이 또 다르다는 것도 알게 되었습니다.\n또한 Zustand를 처음 사용해 상태 관리를 경험했고, Mock API를 활용해 프론트엔드 개발을 진행하는 방법도 익혔습니다.`,
    insights:
    ...
    purpose:
      ...
      role: `프론트엔드 개발
      - 디자인
      - UI 컴포넌트, 페이지 구현 및 스타일링 (카드, 모달, 검색, 팀 찾기, 팀원 찾기)
      - 상태 관리 (Zustand)
      - 라우팅 구조 구현`,
